...
BookReader.prototype.initEmbedNavbar = function() {
    ...
    $('#BookReader').append(
        ...
        +         '<button class="BRicon book_right"></button>'
        +   "</span>"
        +   "<span><a class='logo' href='" + this.logoURL + "' 'target='_blank' >Cornell University</a> / Southeast Asia Visions</span>"
...
BookReader.prototype.initUIStrings = function()
{
    ...
    var titles = { '.logo': 'Southeast Asia Visions home', // $$$ update after getting OL record
                   '.zoom_in': 'Zoom in',
                   '.zoom_out': 'Zoom out',
                   '.onepg': 'One-page view',
                   '.twopg': 'Two-page view',
