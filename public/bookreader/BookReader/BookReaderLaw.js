...
BookReader.prototype.initEmbedNavbar = function() {
    ...
    $('#BookReader').append(
        ...
        +         '<button class="BRicon book_right"></button>'
        +   "</span>"
        +   "<span><a class='logo' href='" + this.logoURL + "' 'target='_blank' >Cornell University</a> / Law Collections</span>"
...
BookReader.prototype.initToolbar = function(mode, ui) {
    ...
    $("#BookReader").append(
        ...
        //+     "<button class='BRicon full'></button>"
        +   "</span>"
        +   "<span><a class='logo' href='" + this.logoURL + "'>Law Collections</a></span>"
...
BookReader.prototype.initUIStrings = function()
{
    ...
    var titles = { '.logo': 'Law Collections home', // $$$ update after getting OL record
                   '.zoom_in': 'Zoom in',
                   '.zoom_out': 'Zoom out',
                   '.onepg': 'One-page view',
                   '.twopg': 'Two-page view',
