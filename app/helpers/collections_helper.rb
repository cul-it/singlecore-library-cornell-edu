module CollectionsHelper
    ...
    def get_landing_page(nickname)
        pages = {
            ...
            adwhite: '/collections/kmoddl',
            aerial: '/collections/kmoddl',
            ahearn: '/collections/kmoddl',
            anthrocollections: '/collections/kmoddl',
            artifacts: '/collections/kmoddl',
            bam: '/collections/kmoddl',
            bastides: '/collections/kmoddl',
            beyondtaj: '/collections/kmoddl',
            blaschka: '/collections/kmoddl',
            bol: '/collections/kmoddl',
            cast: '/collections/kmoddl',
            chla: '/collections/kmoddl',
            coins: '/collections/kmoddl',
            conzo: '/collections/kmoddl',
            cooper: '/collections/kmoddl',
            culmaps: '/collections/kmoddl',
            divinecomedy: '/collections/kmoddl',
            dynkin: '/collections/kmoddl',
            eleusis: '/collections/kmoddl',
            ezra: '/collections/kmoddl',
            fallout: '/collections/kmoddl',
            flow: '/collections/kmoddl',
            gamelan: '/collections/kmoddl',
            gems: '/collections/kmoddl',
            harrisson: '/collections/kmoddl',
            hearth: '/collections/kmoddl',
            hill: '/collections/kmoddl',
            hiphopflyers: '/collections/kmoddl',
            hivebees: '/collections/kmoddl',
            howell: '/collections/kmoddl',
            hunt: '/collections/kmoddl',
            impersonator: '/collections/kmoddl',
            isbell: '/collections/kmoddl',
            iwo: '/collections/kmoddl',
            izq: '/collections/kmoddl',
            izquierda: '/collections/kmoddl',
            japantheatre: '/collections/kmoddl',
            japanworld: '/collections/kmoddl',
            johnclairmiller: '/collections/kmoddl',
            johnclairmillericeland: '/collections/kmoddl',
            karma: '/collections/kmoddl',
            kassoy: '/collections/kmoddl',
            kingsbury: '/collections/kmoddl',
            kmoddl: '/collections/kmoddl',
            leuenberger: '/collections/kmoddl',
            liber: '/collections/kmoddl',
            lindsaycooper: '/collections/kmoddl',
            loewentheil: '/collections/kmoddl',
            may: '/collections/kmoddl',
            mmay: '/collections/kmoddl',
            nur: '/collections/kmoddl',
            obama: '/collections/kmoddl',
            page: '/collections/kmoddl',
            paniccioli: '/collections/kmoddl',
            pjmode: '/collections/kmoddl',
            politicalamericana: '/collections/kmoddl',
            prisonwritings: '/collections/kmoddl',
            punkflyers: '/collections/kmoddl',
            rackeralbums: '/collections/kmoddl',
            ragamala: '/collections/kmoddl',
            railroad: '/collections/kmoddl',
            repsslides: '/collections/kmoddl',
            rmc: '/collections/kmoddl',
            rudin: '/collections/kmoddl',
            sat: '/collections/kmoddl',
            scott: '/collections/kmoddl',
            sea: '/collections/kmoddl',
            seneca: '/collections/kmoddl',
            squeezes: '/collections/kmoddl',
            srilanka: '/collections/kmoddl',
            stereoscopes: '/collections/kmoddl',
            sterrett: '/collections/kmoddl',
            tamang: '/collections/kmoddl',
            tarr: '/collections/kmoddl',
            tellennasbeh: '/collections/kmoddl',
            vicos: '/collections/kmoddl',
            willardstraight: '/collections/kmoddl',
            witchcraft: '/collections/kmoddl',
