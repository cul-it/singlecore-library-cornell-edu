...
=begin
vvv Multi-line comment vvv

This multi-line comment is just to track changes in the main branch given the new formatting
of the Examples: section above. Delete when MAP is merged.
    Examples:
    | nickname | count |
	#
